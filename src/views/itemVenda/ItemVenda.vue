  ...
  <div>
    <v-card>
      ...
      >
        <template v-slot:top>
          <v-toolbar flat>
            <v-toolbar-title>Item para venda</v-toolbar-title>
...
export default {
  ...
  methods: {
    ...mapActions('itemvenda', [
      'ActionListItemVenda',
      'ActionCriarItemVenda',
      'ActionDeleteItemVenda',
      'ActionUpdateItemVenda',
    ]),
    ...mapActions('produto', ['ActionListProduto']),
    ...mapActions('tamanho', ['ActionListTamanho']),
    ...
    save() {
      ...
      if (!this.editedItem.id) {
        this.ActionCriarItemVenda({
          itemvenda: this.editedItem,
        })
      } else {
        this.ActionUpdateItemVenda({
          id: this.editedIndex,
          itemvenda: this.editedItem,
        })
      }
